...
class GrilledNuggetImageVM: ObservableObject {
    var GrilledNuggetImage: [ImageModel] = [
        ImageModel(Rectanglewidth: 300, Rectangleheight: 300, productImage: "Grilled Nuggets", ImageW: 300, ImageH: 300, xOfset: 0, yOfset: 0, productTitle: "GrilledNugget", foodTitleFSize: 40)
    ]
}
...
class GrilledNuggetDataVM: ObservableObject{
    ...
    @Published var GrilledNuggeto4: Bool = false
